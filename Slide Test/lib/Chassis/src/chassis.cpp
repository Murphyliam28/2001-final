...
Twist Chassis::CalcOdomFromWheelMotion(void)
{
     ...
     */
     ...
     //double wheel_track = 14.0;

     double u = ((leftMotor.speed/LEFT_TICKS_PER_CM) + (rightMotor.speed/RIGHT_TICKS_PER_CM))/2.0;

     double omega = ((rightMotor.speed/RIGHT_TICKS_PER_CM) - (leftMotor.speed/LEFT_TICKS_PER_CM))/(ROBOT_RADIUS*2.0);
